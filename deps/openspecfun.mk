...
clean-openspecfun:
	-rm $(build_prefix)/manifest/openspecfun $(BUILDDIR)/$(OPENSPECFUN_SRC_DIR)/build-compiled
	-rm $(build_libdir)/libopenspecfun.a $(build_shlibdir)/libopenspecfun.$(SHLIB_EXT)
